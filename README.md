...
<p align="center">Estudante de programação com foco em Back-end e Análise de Dados · Rio de Janeiro, BR</p>
<p align="center">
...
## Sobre mim 🇧🇷 Português | [🇺🇸 English](./README.en.md)

Estudante de programação com foco em Data analytics, construindo soluções eficientes com Python, Node.js e bancos de dados relacionais. Tenho experiência prática em análise de dados com Pandas e Plotly, e na criação de APIs RESTful com TypeScript e PostgreSQL.

Atualmente aprofundando conhecimentos em análise de dados, SQL avançado e desenvolvimento de sistemas escaláveis.
